                ...
                <form action="<?= route_to('login') ?>" method="post">
                  ...
                  <div class="form-group">
                    <input type="email"
                      ...
                      name="login" aria-describedby="emailHelp" placeholder="<?= lang('Auth.email') ?>">
                  ...
                  <?php if ($config->allowRemembering): ?>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" name="remember" <?php if (old('remember')): ?>
                            checked <?php endif ?>>
...
<!-- Place this part outside the $this->endSection() block -->
<script src="path-to-your-bootstrap-js-file/bootstrap.min.js"></script>